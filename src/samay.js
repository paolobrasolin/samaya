var Samay = (function() {
  ...
  var update = function() {
    return new Promise(function(resolve, reject) {
      fetchCoordinates().then(function(geoposition) {
  ...
  var fetchTwilight = function(date) {
    return new Promise(function(resolve, reject) {
      ...
      }).done(function(json) {return resolve(json);})
        .fail(function(xhr, status, err) {return reject(status + err.message);});
    });
  };
  ...
  return {
    ...
    //    daytime: function(){ return daytime; },
  };
})();
